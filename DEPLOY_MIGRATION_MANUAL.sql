-- 📋 DEPLOYMENT SCRIPT - Copy-paste ke Supabase SQL Editor
-- File: /supabase/migrations/202605030001_advanced_modules.sql
-- Date: 2026-05-03

-- ======================================
-- STEP 1: Create ENUMs (run first)
-- ======================================
DO $$ BEGIN
...
-- Client policies: read own data only
